...
public class MemberController {
	...
	public ModelAndView memberMailListSearch(@RequestParam("com_idx")int com_idx,@RequestParam("memberKeyword")String memberKeyword) {
		List<MemberDTO> memberList = memberService.memberMailListSearch(com_idx, memberKeyword);
		ModelAndView mav = new ModelAndView();
		mav.addObject("memberList",memberList);
		mav.addObject("com_idx",com_idx);
