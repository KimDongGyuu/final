...
public class ComManaController {
	...
	public ModelAndView memberList(
		...
		int totalCnt = memberService.getListTotalCnt(com_idx);
		int listSize = 10;
		int pageSize = 5;
		
		String pageStr = com.ace.page.memberListPage.makePage("clientTel.do", totalCnt, listSize, pageSize, cp, com_idx);
